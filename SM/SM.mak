...
${BUILD_DIR}/ICLK.o: ${SM_SRC_DIR}/ICLK.cc ${SM_HEADER_DIR}/ICLK.h ${SM_HEADER_DIR}/ICLKParams.h ${APPEARANCE_HEADERS} ${STATE_SPACE_HEADERS} ${SM_BASE_HEADERS} ${UTILITIES_HEADER_DIR}/excpUtils.h  ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${MACROS_HEADER_DIR}/register.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${IC_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@
...
${BUILD_DIR}/FCLK.o: ${SM_SRC_DIR}/FCLK.cc ${SM_HEADER_DIR}/FCLK.h ${SM_HEADER_DIR}/FCLKParams.h ${APPEARANCE_HEADERS} ${STATE_SPACE_HEADERS} ${SM_BASE_HEADERS} ${UTILITIES_HEADER_DIR}/excpUtils.h  ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${MACROS_HEADER_DIR}/register.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${FC_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@
...
${BUILD_DIR}/FALK.o: ${SM_SRC_DIR}/FALK.cc ${SM_HEADER_DIR}/FALK.h ${SM_HEADER_DIR}/FALKParams.h ${APPEARANCE_HEADERS} ${STATE_SPACE_HEADERS} ${SM_BASE_HEADERS} ${UTILITIES_HEADER_DIR}/excpUtils.h  ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${MACROS_HEADER_DIR}/register.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${FA_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@
...
${BUILD_DIR}/IALK.o: ${SM_SRC_DIR}/IALK.cc ${SM_HEADER_DIR}/IALK.h ${SM_HEADER_DIR}/IALKParams.h ${APPEARANCE_HEADERS} ${STATE_SPACE_HEADERS} ${SM_BASE_HEADERS} ${UTILITIES_HEADER_DIR}/excpUtils.h  ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${MACROS_HEADER_DIR}/register.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${IA_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@
...
${BUILD_DIR}/AESM.o: ${SM_SRC_DIR}/AESM.cc ${SM_HEADER_DIR}/AESM.h ${SM_HEADER_DIR}/ESM.h ${SM_HEADER_DIR}/ESMParams.h ${APPEARANCE_HEADERS} ${STATE_SPACE_HEADERS} ${SM_BASE_HEADERS} ${UTILITIES_HEADER_DIR}/excpUtils.h  ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${MACROS_HEADER_DIR}/register.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${ESM_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@
...
${BUILD_DIR}/PF.o: ${SM_SRC_DIR}/PF.cc ${SM_HEADER_DIR}/PF.h ${SM_HEADER_DIR}/PFParams.h ${APPEARANCE_HEADERS} ${STATE_SPACE_HEADERS} ${SM_BASE_HEADERS} ${UTILITIES_HEADER_DIR}/excpUtils.h  ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${MACROS_HEADER_DIR}/register.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${PF_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@
...
${BUILD_DIR}/NN.o: ${SM_SRC_DIR}/NN.cc ${SM_HEADER_DIR}/NN.h ${SM_HEADER_DIR}/NNParams.h ${SM_HEADER_DIR}/FLANNParams.h ${SM_HEADER_DIR}/FGNN.h ${SM_HEADER_DIR}/GNN.h ${APPEARANCE_HEADERS} ${STATE_SPACE_HEADERS} ${SM_BASE_HEADERS} ${UTILITIES_HEADER_DIR}/excpUtils.h  ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${MACROS_HEADER_DIR}/register.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${NN_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@
...
${BUILD_DIR}/GNN.o: ${SM_SRC_DIR}/GNN.cc ${SM_HEADER_DIR}/GNN.h ${APPEARANCE_HEADERS} ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${MACROS_HEADER_DIR}/register.h 
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${GNN_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@	
...
${BUILD_DIR}/FGNN.o: ${SM_SRC_DIR}/FGNN.cc ${SM_HEADER_DIR}/FGNN.h ${SM_HEADER_DIR}/GNN.h ${APPEARANCE_HEADERS} ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${MACROS_HEADER_DIR}/register.h 
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${FGNN_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@	
...
${BUILD_DIR}/LineTracker.o: ${SM_SRC_DIR}/LineTracker.cc ${SM_HEADER_DIR}/LineTracker.h ${SM_HEADER_DIR}/CompositeBase.h ${ROOT_HEADER_DIR}/TrackerBase.h ${UTILITIES_HEADER_DIR}/excpUtils.h ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${MACROS_HEADER_DIR}/register.h ${SM_HEADER_DIR}/GridBase.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${LINE_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@
...
${BUILD_DIR}/RegNet_NT.o: ${SM_SRC_DIR}/NT/RegNet.cc ${SM_HEADER_DIR}/NT/RegNet.h ${SM_HEADER_DIR}/RegNetParams.h ${AM_BASE_HEADERS} ${SSM_BASE_HEADERS} ${SM_NT_BASE_HEADERS} ${UTILITIES_HEADER_DIR}/excpUtils.h  ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h 
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${RGN_FLAGS} ${CAFFE_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@
	
${BUILD_DIR}/RKLT_NT.o: ${SM_SRC_DIR}/NT/RKLT.cc ${SM_HEADER_DIR}/NT/RKLT.h ${AM_BASE_HEADERS} ${SSM_BASE_HEADERS} ${SM_NT_BASE_HEADERS} ${UTILITIES_HEADER_DIR}/excpUtils.h ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${SM_HEADER_DIR}/GridBase.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${GRID_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@
...
${BUILD_DIR}/HACLK.o: ${SM_SRC_DIR}/HACLK.cc ${SM_HEADER_DIR}/HACLK.h ${APPEARANCE_HEADERS} ${STATE_SPACE_HEADERS} ${SM_BASE_HEADERS} ${UTILITIES_HEADER_DIR}/excpUtils.h  ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${MACROS_HEADER_DIR}/register.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${HAC_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@	
...
${BUILD_DIR}/FESMBase.o: ${SM_SRC_DIR}/FESMBase.cc ${SM_HEADER_DIR}/FESMBase.h ${APPEARANCE_HEADERS} ${STATE_SPACE_HEADERS} ${SM_BASE_HEADERS} ${UTILITIES_HEADER_DIR}/excpUtils.h  ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${MACROS_HEADER_DIR}/register.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${FESMBase_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@	
...
${BUILD_DIR}/FESM.o: ${SM_SRC_DIR}/FESM.cc ${SM_HEADER_DIR}/FESM.h ${SM_HEADER_DIR}/FESMBase.h ${APPEARANCE_HEADERS} ${STATE_SPACE_HEADERS} ${SM_BASE_HEADERS} ${UTILITIES_HEADER_DIR}/excpUtils.h  ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${MACROS_HEADER_DIR}/register.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${FESM_FLAGS} $< ${FLAGS64} ${FLAGSCV} -o $@
