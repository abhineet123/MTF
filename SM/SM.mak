...
ifeq (${only_nt}, 0)
	...
	ifeq (${nn}, 1)
		...
		MTF_RUNTIME_FLAGS += -D DISABLE_NN -D DISABLE_HDF5
		MTF_COMPILETIME_FLAGS += -D DISABLE_NN -D DISABLE_HDF5
	endif
	ifeq (${hdf5}, 1)
		MTF_LIBS += -lhdf5
		ifeq ($(OS),Windows_NT)
	...
	SEARCH_METHODS_NT += GNN
	SEARCH_PARAMS += FLANNCV
	MTF_RUNTIME_FLAGS += -D ENABLE_ONLY_NT -D DISABLE_NN -D DISABLE_HDF5
	MTF_COMPILETIME_FLAGS += -D ENABLE_ONLY_NT -D DISABLE_NN -D DISABLE_HDF5
endif
