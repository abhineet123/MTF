...
if (WIN32)
option(WITH_NN "Enable FLANN based NN tracker (Needs a custom version of FLANN)" OFF)
else()
option(WITH_NN "Enable FLANN based NN tracker" ON)
endif()
...
if(WITH_NN)
	find_package(FLANN)
	if (WIN32)
	find_package(HDF5 COMPONENTS C static NO_MODULE)
	else()
	find_package(HDF5)
	endif()
	if(FLANN_FOUND AND HDF5_FOUND) 
		...
		set(MTF_EXT_INCLUDE_DIRS ${MTF_EXT_INCLUDE_DIRS} ${FLANN_INCLUDE_DIRS} ${HDF5_INCLUDE_DIRS})
		...
		message(STATUS "FLANN and/or HDF5 not found so the templated version NN has been disabled")
