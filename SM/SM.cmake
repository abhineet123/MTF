...
option(WITH_GRID_FEAT "Enable Feature based Grid (RANSAC) Tracker (requires nonfree OpenCV module)" ON)
...
set(MTF_RUNTIME_FLAGS ${MTF_RUNTIME_FLAGS} -DENABLE_ONLY_NT)
endif()
...
if(WITH_REGNET)
	...
	set(MTF_RUNTIME_FLAGS ${MTF_RUNTIME_FLAGS} -DDISABLE_REGNET)
endif(WITH_REGNET)
