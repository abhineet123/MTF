...
${BUILD_DIR}/warpUtils.o: ${UTILITIES_SRC_DIR}/warpUtils.cc ${UTILITIES_HEADER_DIR}/warpUtils.h ${MACROS_HEADER_DIR}/common.h ${UTILITIES_HEADER_DIR}/miscUtils.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${FLAGS64} $< -o $@
	
${BUILD_DIR}/imgUtils.o: ${UTILITIES_SRC_DIR}/imgUtils.cc ${UTILITIES_HEADER_DIR}/imgUtils.h ${UTILITIES_HEADER_DIR}/warpUtils.h ${MACROS_HEADER_DIR}/common.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${FLAGS64} $< -o $@
	
${BUILD_DIR}/histUtils.o: ${UTILITIES_SRC_DIR}/histUtils.cc ${UTILITIES_HEADER_DIR}/histUtils.h ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h 
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${HIST_FLAGS} ${FLAGS64} $< -o $@	
	
${BUILD_DIR}/miscUtils.o: ${UTILITIES_SRC_DIR}/miscUtils.cc ${UTILITIES_HEADER_DIR}/miscUtils.h ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h 
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${HIST_FLAGS} ${FLAGS64} $< -o $@

${BUILD_DIR}/netUtils.o: ${UTILITIES_SRC_DIR}/netUtils.cc  ${UTILITIES_HEADER_DIR}/netUtils.h ${MACROS_HEADER_DIR}/common.h  
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${CAFFE_FLAGS} ${FLAGS64} $< -o $@	

${BUILD_DIR}/graphUtils.o: ${UTILITIES_SRC_DIR}/graphUtils.cc ${UTILITIES_HEADER_DIR}/graphUtils.h ${MACROS_HEADER_DIR}/common.h ${UTILITIES_HEADER_DIR}/miscUtils.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${PROF_FLAGS} ${MTF_COMPILETIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${FLAGS64} $< -o $@
