...
${BUILD_DIR}/CMT.o: ${CMT_SRC_DIR}/CMT.cc ${CMT_HEADERS} ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${ROOT_HEADER_DIR}/TrackerBase.h
	${CXX} -fPIC -c ${WARNING_FLAGS} ${OPT_FLAGS} $< -std=c++11 ${FLAGS64} ${OPENCV_FLAGS} ${MTF_COMPILETIME_FLAGS} -I${CMT_INCLUDE_DIR} -I${UTILITIES_INCLUDE_DIR} -I${MACROS_INCLUDE_DIR} -I${ROOT_INCLUDE_DIR} -o  $@
