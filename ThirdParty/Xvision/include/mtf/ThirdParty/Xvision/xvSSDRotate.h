#ifndef MTF_XVSSD_ROTATE
#define MTF_XVSSD_ROTATE

#include "xvSSDMain.h"

class XVSSDRotate: public XVSSDMain {

	typedef XVRotateStepper< IMAGE_TYPE  > STEPPER_TYPE;
...
public:
	...
	XVSSDRotate(const ParamType *xv_params = NULL) :
		XVSSDMain(xv_params){
				name="rotate";
		}
