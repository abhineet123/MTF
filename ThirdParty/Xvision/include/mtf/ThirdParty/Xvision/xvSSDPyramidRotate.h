#ifndef MTF_XVSSD_PYRAMID_ROTATE_
#define MTF_XVSSD_PYRAMID_ROTATE_

#include "xvSSDMain.h"

class XVSSDPyramidRotate: public XVSSDMain {

	typedef XVPyramidStepper<XVRotateStepper< IMAGE_TYPE > >  STEPPER_TYPE;
...
public:
	...
	XVSSDPyramidRotate(const ParamType *xv_params = NULL, 
