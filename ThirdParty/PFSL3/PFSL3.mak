...
${BUILD_DIR}/PFSL3.o: ${PFSL3_SRC_DIR}/PFSL3.cc ${PFSL3_HEADERS} ${ROOT_HEADER_DIR}/TrackerBase.h
	${CXX} ${MTF_PIC_FLAG} -c -I/usr/include/clapack ${WARNING_FLAGS} ${OPT_FLAGS} ${MTF_INCLUDE_FLAGS} ${MTF_COMPILETIME_FLAGS} $< ${OPENCV_FLAGS} -I${PFSL3_INCLUDE_DIR} -I${ROOT_INCLUDE_DIR} -o  $@	
