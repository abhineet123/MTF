...
namespace frg{
	...
	Fragments_Tracker::Fragments_Tracker(CvMat* I,
		Parameters& in_params, ofstream& log_file)
	{
		dbg = 0;
	...
	Fragments_Tracker::Fragments_Tracker(CvMat* I, Parameters& in_params){
	...
	void Fragments_Tracker::Handle_Frame(CvMat* I, const char* outwin)
	{
	...
	void Fragments_Tracker::Handle_Frame(CvMat* I){
