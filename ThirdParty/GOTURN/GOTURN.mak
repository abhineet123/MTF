...
${BUILD_DIR}/GOTURN.o: ${GOTURN_SRC_DIR}/GOTURN.cc ${GOTURN_HEADERS} ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${ROOT_HEADER_DIR}/TrackerBase.h
	${CXX} -fPIC -c ${WARNING_FLAGS} ${OPT_FLAGS} $< -std=c++11 ${FLAGS64} ${OPENCV_FLAGS} ${MTF_COMPILETIME_FLAGS} ${CAFFE_FLAGS} -I${GOTURN_INCLUDE_DIR} -I${CAFFE_INCLUDE_DIR} -I${UTILITIES_INCLUDE_DIR} -I${MACROS_INCLUDE_DIR} -I${ROOT_INCLUDE_DIR} -o  $@
