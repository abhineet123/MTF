...
THIRD_PARTY_TRACKERS_SO_LOCAL +=  ${TLD_ROOT_DIR}/${CVBLOBS_LIB_SO} ${TLD_ROOT_DIR}/${TLD_LIB_SO}
...
${BUILD_DIR}/TLD.o: ${TLD_SRC_DIR}/TLD.cc ${TLD_HEADERS} ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${ROOT_HEADER_DIR}/TrackerBase.h
	${CXX} -c -fPIC ${WARNING_FLAGS} ${OPT_FLAGS} ${MTF_COMPILETIME_FLAGS} $< ${FLAGS64} ${FLAGSCV} -I${TLD_INCLUDE_DIR} -I${UTILITIES_INCLUDE_DIR} -I${MACROS_INCLUDE_DIR} -I${ROOT_INCLUDE_DIR} -o $@
...
${MTF_LIB_INSTALL_DIR}/${CVBLOBS_LIB_SO}: ${CVBLOBS_ROOT_DIR}/${CVBLOBS_LIB_SO}
	${MTF_LIB_INSTALL_CMD_PREFIX} cp -f $< $@
${TLD_ROOT_DIR}/${CVBLOBS_LIB_SO}: ${CVBLOBS_ROOT_DIR}/${CVBLOBS_LIB_SO}
	cp -f $< $@
