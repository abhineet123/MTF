...
${BUILD_DIR}/MIL.o: ${MIL_SRC_DIR}/MIL.cc ${MIL_HEADERS} ${UTILITIES_HEADER_DIR}/miscUtils.h ${MACROS_HEADER_DIR}/common.h ${ROOT_HEADER_DIR}/TrackerBase.h
	${CXX} -fPIC -c ${WARNING_FLAGS} ${OPT_FLAGS} $< -std=c++11 ${FLAGS64} ${FLAGSCV} ${MTF_COMPILETIME_FLAGS} -I${MIL_INCLUDE_DIR} -I${UTILITIES_INCLUDE_DIR} -I${MACROS_INCLUDE_DIR} -I${ROOT_INCLUDE_DIR} -o  $@
