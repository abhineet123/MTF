...
${BUILD_DIR}/${MTF_REC_EXE_NAME}: ${EXAMPLES_SRC_DIR}/recordSeq.cc ${EXAMPLES_HEADERS}
	${CXX}  $< -o $@ -w ${WARNING_FLAGS} ${MTF_RUNTIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${EXAMPLES_INCLUDE_FLAGS} ${CONFIG_INCLUDE_FLAGS} ${MTF_LIBS_DIRS} ${OPENCV_FLAGS} ${LIBS} ${BOOST_LIBS} ${LIBS_PARALLEL} ${MTF_LIBS} ${OPENCV_LIBS} 
...
${BUILD_DIR}/${MTF_TEST_EXE_NAME}: ${EXAMPLES_SRC_DIR}/testMTF.cc ${TEST_HEADERS} ${MTF_HEADERS}
