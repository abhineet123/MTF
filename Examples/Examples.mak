...
ifeq (${o}, 1)
	...
	_MTF_MEX2_MODULE_NAME = mexMTF2_fast
	...
	_MTF_MEX2_MODULE_NAME = mexMTF2_debug
...
MTF_MEX2_MODULE_NAME = $(addsuffix ${LIB_POST_FIX}.${MEX_EXT}, ${_MTF_MEX2_MODULE_NAME})
...
py2: ${BUILD_DIR}/${MTF_PY2_LIB_NAME}
mex: ${BUILD_DIR}/${MTF_MEX_MODULE_NAME}
mex2: ${BUILD_DIR}/${MTF_MEX2_MODULE_NAME}
...
install_mex2: ${MTF_MEX_INSTALL_DIR}/${MTF_MEX2_MODULE_NAME}
...
${MTF_MEX_INSTALL_DIR}/${MTF_MEX_MODULE_NAME}: ${BUILD_DIR}/${MTF_MEX_MODULE_NAME}
	${MTF_EXE_INSTALL_CMD_PREFIX} ${CP_CMD} $< $@
${MTF_MEX_INSTALL_DIR}/${MTF_MEX2_MODULE_NAME}: ${BUILD_DIR}/${MTF_MEX2_MODULE_NAME}
	${MTF_EXE_INSTALL_CMD_PREFIX} ${CP_CMD} $< $@
...
${MTF_PY_INSTALL_DIR}/${MTF_PY2_LIB_NAME}: ${BUILD_DIR}/${MTF_PY2_LIB_NAME}
	${MTF_PY_INSTALL_CMD_PREFIX} ${CP_CMD} $< $@
...
${BUILD_DIR}/${MTF_PY2_LIB_NAME}: | ${BUILD_DIR}	
...
${BUILD_DIR}/${MTF_MEX2_MODULE_NAME}: | ${BUILD_DIR}	
...
${BUILD_DIR}/${MTF_PY2_LIB_NAME}: ${BUILD_DIR}/pyMTF.o 
	${CXX} -shared $< -o $@ ${MTF_LIB_LINK} ${LIBS} ${LIBS_PARALLEL} ${MTF_RUNTIME_FLAGS} ${MTF_LIB_LINK} ${MTF_LIBS_DIRS} ${MTF_LIBS} ${OPENCV_LIBS} ${BOOST_LIBS} ${PYTHON_LIBS_FLAGS} ${PYTHON_LIBS}
...
${BUILD_DIR}/pyMTF2.o: ${EXAMPLES_SRC_DIR}/pyMTF2.cc ${MTF_HEADERS}
	${CXX} -w -c -fPIC $< ${WARNING_FLAGS} -D_hypot=hypot ${OPENCV_FLAGS} ${MTF_RUNTIME_FLAGS} ${MTF_INCLUDE_FLAGS} ${EXAMPLES_INCLUDE_FLAGS} -I${PYTHON_INCLUDE_DIR} -I${NUMPY_INCLUDE_DIR} -o $@

${BUILD_DIR}/${MTF_MEX_MODULE_NAME}: ${EXAMPLES_SRC_DIR}/mexMTF.cc ${MTF_HEADERS}
	$(MEX) $(MEX_OPTION) $(MEX_LIBS) $< -output $@
	
${BUILD_DIR}/${MTF_MEX2_MODULE_NAME}: ${EXAMPLES_SRC_DIR}/mexMTF2.cc ${MTF_HEADERS}
	$(MEX) $(MEX_OPTION) $(MEX_LIBS) $< -output $@
