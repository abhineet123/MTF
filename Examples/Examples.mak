...
MTF_APP_INSTALL_DIR ?= .
MTF_APP_SRC_DIR ?= ${EXAMPLES_ROOT_DIR}${PATHSEP}src
...
EXAMPLES_SRC_DIR = ${EXAMPLES_ROOT_DIR}${PATHSEP}src
EXAMPLES_INCLUDE_DIR = ${EXAMPLES_ROOT_DIR}${PATHSEP}include
EXAMPLES_HEADER_DIR = ${EXAMPLES_INCLUDE_DIR}${PATHSEP}mtf${PATHSEP}Tools
EXAMPLES_INCLUDE_FLAGS = -I${EXAMPLES_INCLUDE_DIR}
EXAMPLES_TOOLS = PreProc cvUtils inputBase inputCV pipeline

EXAMPLES_TOOLS_HEADERS = $(addprefix ${EXAMPLES_HEADER_DIR}${PATHSEP},$(addsuffix .h, ${EXAMPLES_TOOLS}))
...
exe: ${BUILD_DIR}${PATHSEP}${MTF_EXE_NAME}
uav: ${BUILD_DIR}${PATHSEP}${MTF_UAV_EXE_NAME}
mos: ${BUILD_DIR}${PATHSEP}${MTF_MOS_EXE_NAME}
syn: ${BUILD_DIR}${PATHSEP}${MTF_SYN_EXE_NAME}
py: ${BUILD_DIR}${PATHSEP}${MTF_PY_LIB_NAME}
test: ${BUILD_DIR}${PATHSEP}${MTF_TEST_EXE_NAME}
gt: ${BUILD_DIR}${PATHSEP}${MTF_GT_EXE_NAME}
patch: ${BUILD_DIR}${PATHSEP}${MTF_PATCH_EXE_NAME}
rec: ${BUILD_DIR}${PATHSEP}${MTF_REC_EXE_NAME}
app: ${BUILD_DIR}${PATHSEP}${MTF_APP_EXE_NAME}
all: exe uav mos syn py test gt patch rec

install_exe: ${MTF_EXEC_INSTALL_DIR}${PATHSEP}${MTF_EXE_NAME}
install_gt: ${MTF_EXEC_INSTALL_DIR}${PATHSEP}${MTF_GT_EXE_NAME}
install_uav: ${MTF_EXEC_INSTALL_DIR}${PATHSEP}${MTF_UAV_EXE_NAME}
install_mos: ${MTF_EXEC_INSTALL_DIR}${PATHSEP}${MTF_MOS_EXE_NAME}
install_patch: ${MTF_EXEC_INSTALL_DIR}${PATHSEP}${MTF_PATCH_EXE_NAME}
install_syn: ${MTF_EXEC_INSTALL_DIR}${PATHSEP}${MTF_SYN_EXE_NAME}
install_rec: ${MTF_EXEC_INSTALL_DIR}${PATHSEP}${MTF_REC_EXE_NAME}
install_py: ${MTF_PY_INSTALL_DIR}${PATHSEP}${MTF_PY_LIB_NAME}
install_test: ${MTF_TEST_INSTALL_DIR}${PATHSEP}${MTF_TEST_EXE_NAME}
install_app: ${MTF_APP_INSTALL_DIR}${PATHSEP}${MTF_APP_EXE_NAME}
...
mtfc: all
	${RM_CMD} ${BUILD_DIR}${PATHSEP}${MTF_EXE_NAME}

run: install_exe
	${MTF_EXE_NAME}
${MTF_EXEC_INSTALL_DIR}${PATHSEP}${MTF_EXE_NAME}: ${BUILD_DIR}${PATHSEP}${MTF_EXE_NAME}
	${MTF_EXE_INSTALL_CMD_PREFIX} ${CP_CMD} $< $@	
${MTF_EXEC_INSTALL_DIR}${PATHSEP}${MTF_UAV_EXE_NAME}: ${BUILD_DIR}${PATHSEP}${MTF_UAV_EXE_NAME}
	${MTF_EXE_INSTALL_CMD_PREFIX} ${CP_CMD} $< $@
${MTF_EXEC_INSTALL_DIR}${PATHSEP}${MTF_PATCH_EXE_NAME}: ${BUILD_DIR}${PATHSEP}${MTF_PATCH_EXE_NAME}
	${MTF_EXE_INSTALL_CMD_PREFIX} ${CP_CMD} $< $@
${MTF_EXEC_INSTALL_DIR}${PATHSEP}${MTF_SYN_EXE_NAME}: ${BUILD_DIR}${PATHSEP}${MTF_SYN_EXE_NAME}
	${MTF_EXE_INSTALL_CMD_PREFIX} ${CP_CMD} $< $@
${MTF_EXEC_INSTALL_DIR}${PATHSEP}${MTF_GT_EXE_NAME}: ${BUILD_DIR}${PATHSEP}${MTF_GT_EXE_NAME}
	${MTF_EXE_INSTALL_CMD_PREFIX} ${CP_CMD} $< $@
${MTF_EXEC_INSTALL_DIR}${PATHSEP}${MTF_MOS_EXE_NAME}: ${BUILD_DIR}${PATHSEP}${MTF_MOS_EXE_NAME}
	${MTF_EXE_INSTALL_CMD_PREFIX} ${CP_CMD} $< $@
${MTF_PY_INSTALL_DIR}${PATHSEP}${MTF_PY_LIB_NAME}: ${BUILD_DIR}${PATHSEP}${MTF_PY_LIB_NAME}
	${MTF_PY_INSTALL_CMD_PREFIX} ${CP_CMD} $< $@
${MTF_TEST_INSTALL_DIR}${PATHSEP}${MTF_TEST_EXE_NAME}: ${BUILD_DIR}${PATHSEP}${MTF_TEST_EXE_NAME}
	${MTF_TEST_INSTALL_CMD_PREFIX} ${CP_CMD} $< $@
${MTF_TEST_INSTALL_DIR}${PATHSEP}${MTF_REC_EXE_NAME}: ${BUILD_DIR}${PATHSEP}${MTF_REC_EXE_NAME}
	${MTF_TEST_INSTALL_CMD_PREFIX} ${CP_CMD} $< $@
${MTF_APP_INSTALL_DIR}${PATHSEP}${MTF_APP_EXE_NAME}: ${BUILD_DIR}${PATHSEP}${MTF_APP_EXE_NAME}
