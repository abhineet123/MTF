...
int main(){
	...
	mtf::utils::InputCV uav_input('j', "uav_sim");
	...
	mtf::utils::GaussianSmoothing uav_pre_proc(uav_tracker.inputType());
	uav_pre_proc.initialize(uav_input.getFrame());
	mtf::utils::GaussianSmoothing satellite_pre_proc(uav_tracker.inputType());
