...
if(Matlab_FOUND)
	...
	message("\n\tIf Matlab is installed but not detected, mexMTF can be compiled by running the  command in mtf_mex_cmd.txt at the MATLAB prompt after removing all semi colons and replacing all occurences of the type '-l<full path to library>' and '-l-L<path to library folder>' with '<full path to library>' and '-L<path to library folder>' respectively\n")
	...
	set(MEX_COMMAND "mex -v CFLAGS='${MEX_CFLAGS}' CXXFLAGS='${MEX_CFLAGS}' ${MEX_MTF_LIBS} Examples/cpp/mexMTF.cc")
