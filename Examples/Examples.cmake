...
if(Matlab_FOUND)
	...
	addPrefixAndSuffix("${MTF_INCLUDE_DIRS}" "-I" " " MEX_MTF_INCLUDE_DIRS)
	addPrefixAndSuffix("${MTF_EXT_INCLUDE_DIRS}" "-I" " " MEX_MTF_EXT_INCLUDE_DIRS)
	...
	set(MEX_COMMAND "mex CFLAGS='${MEX_CFLAGS}' CXXFLAGS='${MEX_CFLAGS}' ${MEX_MTF_LIBS} mexMTF.cc -o mexMTF")
