...
A simple interface for [**ROS**](http://www.ros.org/) called [mtf_bridge](https://github.com/abhineet123/MTF_BRIDGE) (present in the `ROS` sub folder) is likewise provided for seamless integration with robotics projects.
