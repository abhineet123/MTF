...
if(WIN32)
	install(TARGETS mtf_diag ARCHIVE DESTINATION ${MTF_LIB_INSTALL_DIR} COMPONENT diag_lib)
else()
	install(TARGETS mtf_diag LIBRARY DESTINATION ${MTF_LIB_INSTALL_DIR} COMPONENT diag_lib)
endif()  
